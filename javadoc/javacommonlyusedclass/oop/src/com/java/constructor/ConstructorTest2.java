...
public class ConstructorTest2 {
    ...
    public static void main(String[] args) {
        ...
        Person1 p = new Person1("张三", 18, '男', 180, 55.55);
...
class Person1{
    ...
    public Person1(String name, int age, char gender, double height){
        this(name, age, gender);
        this.height = height;
    }

    public Person1(String name, int age, char gender, double height, double weight){
