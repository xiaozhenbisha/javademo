...
public class Demo2 {
    ...
    */
    ...
    public void test2()throws Exception{
        OutputStream out=new FileOutputStream("/Users/wangzhennan/Desktop/javademo/javadoc/testio/java.txt");
        out.write(97);
    ...
    public void test() throws Exception {//在运行一遍是追加还是覆盖？ 覆盖(输出流的位置)
        ...
        OutputStream out=new FileOutputStream("/Users/wangzhennan/Desktop/javademo/javadoc/testio/java.txt",true);
        //2. 数据的操作
        out.write(65);//a写到文件中
        out.write(66);//b写到文件中
