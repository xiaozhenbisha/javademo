...
public class Home3 {
    ...
    public void test1()  {
        ...
        try {
            in=new ObjectInputStream(new FileInputStream("d:/testIO/message.dat"));
    ...
    public static void main(String[] args) {
        ...
        try {
            out=new ObjectOutputStream(new FileOutputStream("d:/testIO/message.dat"));//这行代码出现异常out是null
