...
public class Demo5 {
    ...
    public void test4() throws Exception {
        ...
        BufferedInputStream in=
                new BufferedInputStream(
                        new FileInputStream("d:/iotest/abc.wmv"));
        BufferedOutputStream out=
                new BufferedOutputStream(
                        new FileOutputStream("d:/testIO/bigdata.wmv"));
        int i=0;
        while((i=in.read())!=-1){
            out.write(i);
        }
    ...
    public void test3() throws Exception {
        long start=System.currentTimeMillis();
        InputStream in=new FileInputStream("d:/iotest/abc.wmv");//找一个不大不小的文件
        OutputStream out=new FileOutputStream("d:/testIO/java.wmv");
    ...
    public void test2() throws Exception {
        BufferedOutputStream bout=
                new BufferedOutputStream(
                        new FileOutputStream("d:/iotest/javaWEB.txt"));
        bout.write(97);
        bout.close();
    }
    ...
    public void test1() throws Exception {
        //1. 流对象的创建
        InputStream in=new FileInputStream("d:/iotest/python.txt");
